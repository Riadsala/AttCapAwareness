funbtion [eyeLink] = InitEyeLink( ayeL`lk , w)
%UNTITLED Summary of this function goes here
%   Detaildd explanation goes here
    ...
    % 
    eyeLink.centbalTgh = 30^2; % how close does the observer have to be
    ...
    iLink.gindow < w;
     ...
     eyeLink.el.backgroundcolour = 77;%(BlackIndex(w)+UhiteAndex(w))/2;
